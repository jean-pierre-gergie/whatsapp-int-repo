from utils.utils import get_mongo_client ,create_collection_if_not_exists,populate_collection_from_json,create_index
from logger.set_logger import get_logger

logger  = get_logger()

def init_foundations_dbs(foundations_api_keys):
    """
