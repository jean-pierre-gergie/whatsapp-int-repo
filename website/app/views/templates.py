...
def create_template():
    ...
    try:
        ...
        logger.debug(f"Template name: {template_name}, Category: {category}, Language: {language_code}")
        ...
        logger.debug(f"Header component: {components}")
        ...
        logger.debug(f"Body component: {components}")
